...
const SAMPLE_ARTICLES: Article[] = [
  {
    ...
    title: "BBC News · US justice department drops probe into Fed chairman Jerome Powell",
    source: "url",
    isSample: true,
    createdAt: 1745539200000,
    content: `US justice department drops probe into Fed chairman Jerome Powell
...
Powell's term expires on 15 May, but he is planning to remain in post until his successor, Warsh, is confirmed by the Senate.`,
  },
  {
    ...
    content: `Your bad habits are destroying your charging cables
...
If you find yourself lying in bed with your phone plugged in, pulling the connector at a sharp angle to keep using it, you're asking for trouble
